export const allQuestion = [
  {
    question:
      'Which of the following describes your usual appetite and digestion?',
    answer: [
      {
        data: 'Poor digestion',
        ind: 4,
  ...
  // {
  //   question:
  //     "Which of the following describes how your body feels from changes in weather or environment? ",
  //   answer: [
  //     {
  ...
  // {
  //   question:
  //     "(Optional) Do you often experience any of these women's health conditions?",
  //   answer: [
  //     {
